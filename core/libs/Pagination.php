...
class Pagination
{
    ...
    public function getHTML()
    {
        ...
        if ($this->currentPage > 3){
            $srartpage = "<li><a class='nav-link' href='{$this->uri}page=1'>&laquo;</a></li>";
        }
        ...
        return '<ul class="pagination">' . $srartpage.$back.$page2left.$page1left.'<li class="active"><a>' .$this->currentPage. '</a></li>' .$page1right.$page2right.$forward.$endpage . '</ul>';
    }
