<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Редактирование товара</a></li>
    </ol>
</section>
                ...
                <form action="<?=ADMIN;?>/product/edit" method="post" data-toggle="validator">
                    <div class="box-body">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" name="price" class="form-control" id="price" placeholder="Цена" pattern="^[0-9.]{1,}$" value="<?=$product->price;?>" required data-error="Допусткаются только цифры">
                            <div class="help-block with-errors"></div>
                        </div>

                        <div class="form-group has-feedback">
                            <label for="old_price">Прежняя цена</label>
                            <input type="text" name="old_price" class="form-control" id="old_price" placeholder="Прежняя цена" pattern="^[0-9.]{1,}$" value="<?=$product->old_price;?>" data-error="Допусткаются только цифры">
                            <div class="help-block with-errors"></div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-4">
                                <div class="box box-danger box-solid file-upload">
                                    ...
                                    <div class="box-body">
                                        <div id="single" class="btn btn-success" data-url="product/add-image" data-name="single">Выберите файл для загрузки</div>
                                        <p><small>Рекомендуемые размеры: 115x200</small></p>
                                        <div class="single">
                            ...
                            <div class="col-md-8">
                                <div class="box box-primary box-solid file-upload">
                                    ...
                                    <div class="box-body">
                                        <div id="multi" class="btn btn-success" data-url="product/add-image" data-name="multi">Выберите файлы для загрузки</div>
                                        <p><small>Рекомендуемые размеры: 700x1000</small></p>
                                        <div class="multi">
                                            <?php if (!empty($gallery)): ?>
                                                <?php foreach ($gallery as $item) :?>
                                                    <img src="/images/<?=$item;?>"  alt="" style="max-height: 150px; cursor: pointer" data-id="<?=$product->id?>" data-source="<?=$item;?>" class="del-item">
                                                <?php endforeach;?>
                                            <?php endif;?>
                                        </div>
                                    </div>
                    ...
                    <div class="box-footer">
                        ...
                        <button type="submit" class="btn btn btn-success">Сохранить</button>
                    </div>
                </form>
            </div>
        </div>
