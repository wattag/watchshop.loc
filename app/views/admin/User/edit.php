...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Редактирования пользователя</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
                ...
                <form action="<?= ADMIN;?>/user/edit" method="post" data-toggle="validator">
                    <div class="box-body">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="password" class="form-control" name="password" id="password" placeholder="Введите новый пароль (если хотите его изменить)">
                        </div>
                        <div class="form-group has-feedback">
            ...
            <div class="box">
                <div class="box-body">
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <?php foreach ($orders as $order):?>
                                    ...
                                    <tr class="<?=$class?>">
                                        ...
                                        <td><a style="color: #333333" href="<?=ADMIN;?>/order/view?id=<?=$order['id'];?>"><i class="fa fa-fw fa-eye "></i></a></td>
                                    </tr>
                                <?php endforeach;?>
                                </tbody>
                            </table>
                    ...
                    <?php else: ?>
                        <p class="text-danger"> Пользователь еще пока ничего не заказывал...</p>
                    <?php endif;?>
                </div>
            </div>
        </div>
